...
Understand Domain is a focused, shareable agent workflow.

## What it does

Extract business-domain knowledge from a codebase and generate an interactive domain flow graph. Use when the user explicitly requests this capability or a closely related task.
